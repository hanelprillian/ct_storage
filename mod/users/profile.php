...
function ValidateForm() {
	...
	<div class="box">
		...
		<div class="content">
			<table width="100%" class="table table-hover table-background table-bordered">
				<form action="?mod=users&page=profile&act=apply" method="post" enctype="multipart/form-data" name="generalset">
					<tbody>
						<tr>
	...
	<div class="box">
		...
		<div class="content">
			...
			<table width="100%" class="table table-hover table-background table-bordered">
				<form action="?mod=users&page=profile&act=apply" method="post" enctype="multipart/form-data" name="passwordset">
					<tbody>
						<tr>
